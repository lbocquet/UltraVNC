...
// 
// 2.When then plugin is Inited from UltraVNC Viewer or Server, right after Startup() call (CASE 2);
...
//  - Return any other Plugin parameters value otherwise (not used in UltraVNC Server & UltraVNC Viewer for now)
...
//    from UltraVNC Viewer/Server's socket.
...
//
// Explanation: When UltraVNC Viewer/Server wants to restore some data, it does the following:
